...
pub const INVADER_SPEED: f32 = 100.0;
pub const INVADER_AMOUNT: i32 = 5;
pub const INVADER_SIZE: f32 = 20.0;
pub const SCORE_BOARD_PADDING: f32 = 20.0;
pub const FIRE_LENGTH: f32 = 10.0;
...
pub const HIGHEST_SCORE_FILE_NAME: &str = "highest_score.db";
